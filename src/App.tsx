      ...
      <div id="my-calendar" className="min-h-screen flex flex-col justify-center items-center gap-10 bg-neutral-800 text-white select-none">
        ...
        <div className="px-5 sm:px-3 md:px-2 grid grid-cols-7 gap-3 md:gap-4">
          ...
          {calendars[selectedCalendar].calendar.map((day) => (
            <button
              key={day.day}
              className={`w-10 h-10 md:w-12 md:h-12 p-3 border-2 flex justify-center items-center rounded-full hover:border-gold hover:text-gold disabled:border-neutral-600 disabled:text-neutral-600 cursor-pointer disabled:cursor-default smoother-2 ${
